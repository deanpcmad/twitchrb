  ...
  class Prediction < Object
    ...
    class << self
      ...
      def list(broadcaster_id:, **params)
        response = Client.get_request("predictions", params: params.merge(broadcaster_id: broadcaster_id))
      ...
      def create(broadcaster_id:, title:, outcomes:, duration:, **params)
        ...
        response = Client.post_request("predictions", body: attrs.merge(params))
      ...
      def end(broadcaster_id:, id:, status:, **params)
        ...
        response = Client.patch_request("predictions", body: attrs.merge(params))
