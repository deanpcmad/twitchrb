  ...
  class Subscription < Object
    ...
    class << self
      ...
      def list(broadcaster_id:, **params)
        response = Client.get_request("subscriptions", params: params.merge(broadcaster_id: broadcaster_id))
      ...
      def is_subscribed(broadcaster_id:, user_id:, **params)
        ...
        response = Client.get_request("subscriptions/user", params: attrs.merge(params))
        Collection.from_response(response, type: Subscription)
      end
      ...
      def counts(broadcaster_id:)
        response = Client.get_request("subscriptions", params: {broadcaster_id: broadcaster_id})
