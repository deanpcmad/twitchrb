  ...
  class Poll < Object
    ...
    class << self
      ...
      def list(broadcaster_id:, **params)
        response = Client.get_request("polls", params: params.merge(broadcaster_id: broadcaster_id))
      ...
      def create(broadcaster_id:, title:, choices:, duration:, **params)
        ...
        response = Client.post_request("polls", body: attrs.merge(params))
      ...
      def end(broadcaster_id:, id:, status:)
        ...
        response = Client.patch_request("polls", body: attrs)
